...
import os, time, threading, stomp
...
class VoiceActiveMQ(NonBlockingThreadedBaseVoice):
    ...
    class Listener(stomp.ConnectionListener):
        ...
        def __init__(self, parent):
            ...
            self._message_state_nothing = message_state_format % self._cfg.get('ActiveMQ', 'message_state_nothing')
            self._message_state_speaking = message_state_format % self._cfg.get('ActiveMQ', 'message_state_speaking')
            self._message_state_listening = message_state_format % self._cfg.get('ActiveMQ', 'message_state_listening')
        ...
        def on_message(self, headers, message):
            if message == self._message_state_nothing: 
                ...
                Logger.debug(__name__, 'Apparently computation is happening...')
    ...
    def _produce_voice(self, text, prepared_text, cat = None, id = None, slots = None):
        """
